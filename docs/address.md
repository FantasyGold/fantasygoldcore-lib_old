# FantasyGold Address
Represents a FantasyGold address. Addresses are the most popular way to make FantasyGold transactions. See [the FantasyGold documentation](https://fantasygold-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/fantasygoldevo/bitcore-fantasygold/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/fantasygoldevo/bitcore-fantasygold/tree/master/lib/errors/spec.js).

...
For detailed technical information about a block please visit [Blocks](https://fantasygold-docs.github.io/en/glossary/block) on the FantasyGold Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://fantasygold-docs.github.io/en/developer-reference#block-headers) page on the FantasyGold Developer Reference Wiki.

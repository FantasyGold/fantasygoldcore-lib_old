...
describe('Proposal', function() {
  ...
  it('should create new proposal', function() {
    ...
    proposal.type = 1;
    proposal.url = "http://www.fantasygold.org";
  ...
  it('should throw error if payment address is P2SH', function() {
    ...
    proposal2.name = 'Proposal-36-FantasyGoldATM';
    ...
    proposal2.type = 1;
    proposal2.url = "https://www.fantasygoldcentral.org/p/Proposal-36-FantasyGoldATM";
  ...
  it('should parse a serialised datahex proposal', function(){
    ...
    expect(proposal1.url).to.equal('https://www.fantasygoldcentral.org/p/test_proposal_1519097947');

...
addNetwork({
  ...
  privatekey: 0x212,
  scripthash: 0x18,
  xpubkey: 0x4653474D,    // 'xpub' (Bitcoin Default)
  xprivkey: 0x66736770,   // 'xprv' (Bitcoin Default)
  networkMagic: 0x54494D42,
  port: 57810,
  dnsSeeds: [
    '178.79.181.239',
    '45.77.144.121',
...
addNetwork({
  ...
  xprivkey: 0x31805837    // 'tprv' (Bitcoin Default)
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'testnet-1.fantasygold.network',
    'testnet-2.fantasygold.network'
  ]
};
